...
def check_deps(config):
    ...
    for dep in deps:
        ...
        if child.returncode != 0:
            print('{} needs to be installed!'.format(dep))
            return child.returncode
        print('{:20s} - installed'.format(dep))
...
def check_style(config):
    ...
    if child.returncode != 0 or len(extract_stdout(child)) != 0:
        ...
        if coding_style_grade < config.coding_style:
            ...
            reason = 'No coding style errors automatically detected (tests points {}/{})'.format(config.grade,
                                                                                                 config.tests_points)
